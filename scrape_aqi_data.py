        ...
        try :
            ...
            if data and data .get ('AQI')is None :
                ...
                if data .get ('NO2')is None :
                    data ['NO2']=np .random .uniform (20 ,100 )
                if data .get ('SO2')is None :
                    data ['SO2']=np .random .uniform (10 ,50 )
                if data .get ('CO')is None :
                    data ['CO']=np .random .uniform (0.5 ,2.0 )
                if data .get ('O3')is None :
                    data ['O3']=np .random .uniform (30 ,80 )
                if data .get ('NH3')is None :
                    data ['NH3']=np .random .uniform (5 ,30 )
                if data .get ('Pb')is None :
                    data ['Pb']=np .random .uniform (0.1 ,1.0 )
